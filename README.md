...
- The wander step is intentionally cheap. It does not pathfind, does not run herd logic, and only checks a few chunk/terrain queries to keep movement on nearby walkable ground.
