...
static const uint kChunkBufferPageStateAvailable = 0u;
static const uint kChunkBufferPageStatePendingOpen = 1u;
static const uint kChunkBufferPageStatePendingUploaded = 2u;
static const uint kChunkBufferPageStateResident = 3u;
