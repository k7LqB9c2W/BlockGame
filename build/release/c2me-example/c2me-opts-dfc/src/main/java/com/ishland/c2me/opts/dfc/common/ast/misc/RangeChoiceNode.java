...
//        }
    ...
    public void doBytecodeGenSingle(BytecodeGen.Context context, InstructionAdapter m, BytecodeGen.Context.LocalVarConsumer localVarConsumer) {
        ValuesMethodDefD inputMethod = context.newSingleMethod(this.input);
        ValuesMethodDefD whenInRangeMethod = context.newSingleMethod(this.whenInRange);
        ValuesMethodDefD whenOutOfRangeMethod = context.newSingleMethod(this.whenOutOfRange);
    ...
    public void doBytecodeGenMulti(BytecodeGen.Context context, InstructionAdapter m, BytecodeGen.Context.LocalVarConsumer localVarConsumer) {
        ValuesMethodDefD inputSingle = context.newSingleMethod(this.input);
        ValuesMethodDefD whenInRangeSingle = context.newSingleMethod(this.whenInRange);
        ValuesMethodDefD whenOutOfRangeSingle = context.newSingleMethod(this.whenOutOfRange);
        ValuesMethodDefD inputMulti = context.newMultiMethod(this.input);
...
//            context.callDelegateSingle(m, whenInRangeSingle);
    ...
    public String doCLGen(OpenCLGen.Context context) {
        ...
        ValuesMethodDefD whenInRange = context.newMethod(this.whenInRange);
        ValuesMethodDefD whenOutOfRange = context.newMethod(this.whenOutOfRange);
        return "double v = " + context.callDelegate(input) + ";\n" +
                "return (v >= " + literal(this.minInclusive) + " && v < " + literal(this.maxExclusive) + ") ? " + context.callDelegate(whenInRange) + " : " + context.callDelegate(whenOutOfRange) + ";\n";
    }
