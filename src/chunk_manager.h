...
struct ChunkProfilingSnapshot
{
    ...
    double exactFillDispatchMsLastFrame{0.0};
    double exactFillSupportDiscoveryMsLastFrame{0.0};
    double exactFillSupportPreparationMsLastFrame{0.0};
    double exactFillBatchCpuPreparationMsLastFrame{0.0};
    double exactFillBatchQueueWaitMsLastFrame{0.0};
    double exactFillBatchExactGpuEnqueueMsLastFrame{0.0};
    ...
    int exactFillSupportPagesQueued{0};
    int exactFillSupportPagesReady{0};
    int exactFillSupportPagesBlocked{0};
    int exactFillBatchesQueued{0};
    int exactFillBatchesPreparing{0};
    int exactFillBatchesPrepared{0};
    int exactFillChunksPrepared{0};
    int exactFillChunksSubmittedToExactGpu{0};
    int exactFillChunksCommitted{0};
    int exactFillStaleBatchesDropped{0};
    int exactFillFallbackChunks{0};
...
struct ChunkBenchmarkReport
{
    ...
    BenchmarkStageStats exactFillDispatchStage{};
    BenchmarkStageStats exactFillSupportDiscoveryStage{};
    BenchmarkStageStats exactFillSupportPreparationStage{};
    BenchmarkStageStats exactFillBatchCpuPreparationStage{};
    BenchmarkStageStats exactFillBatchQueueWaitStage{};
    BenchmarkStageStats exactFillBatchExactGpuEnqueueStage{};
    BenchmarkStageStats exactGpuFeedBatchSize{};
    ...
    std::uint64_t exactFillSupportPagesQueued{0};
    std::uint64_t exactFillSupportPagesReady{0};
    std::uint64_t exactFillSupportPagesBlocked{0};
    std::uint64_t exactFillBatchesQueued{0};
    std::uint64_t exactFillBatchesPreparing{0};
    std::uint64_t exactFillBatchesPrepared{0};
    std::uint64_t exactFillChunksPrepared{0};
    std::uint64_t exactFillChunksSubmittedToExactGpu{0};
    std::uint64_t exactFillChunksCommitted{0};
    std::uint64_t exactFillStaleBatchesDropped{0};
    std::uint64_t exactFillFallbackChunks{0};
};
