...
struct ChunkProfilingSnapshot
{
    ...
    int exactGpuComputeInFlightAfterEmitLastCycle{0};
    int exactGpuBlockingEmitBatchBuildsLastCycle{0};
    int exactGpuSubmitBatchBuildsLastCycle{0};
    int exactGpuEmitBatchBuildsLastCycle{0};
...
struct ChunkBenchmarkReport
{
    ...
    BenchmarkStageStats exactGpuComputeInFlightAfterEmit{};
    BenchmarkStageStats exactGpuBlockingEmitBatchAgeStage{};
    BenchmarkStageStats exactGpuBlockingEmitBatchBuilds{};
    BenchmarkStageStats exactGpuSubmitBatchBuilds{};
    BenchmarkStageStats exactGpuEmitBatchBuilds{};
