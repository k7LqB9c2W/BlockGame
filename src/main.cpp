                                ...
                                const RenderDistanceSettings& renderSettings)
{
    ...
    out << ",\"generate_base_terrain_state\":";
    writeStageStatsJson(out, report.generateBaseTerrainStateStage);
    out << ",\"generate_structure_resolve\":";
    writeStageStatsJson(out, report.generateStructureResolveStage);
    out << ",\"generate_gpu_input_prep\":";
    writeStageStatsJson(out, report.generateGpuInputPrepStage);
    out << ",\"generate_cpu_materialize\":";
    writeStageStatsJson(out, report.generateCpuMaterializeStage);
    out << ",\"generate_publish\":";
    writeStageStatsJson(out, report.generatePublishStage);
    out << ",\"generate_worldgen_page_mutex_wait\":";
    writeStageStatsJson(out, report.generateWorldgenPageMutexWaitStage);
    out << ",\"generate_worldgen_page_pending_wait\":";
    writeStageStatsJson(out, report.generateWorldgenPagePendingWaitStage);
    out << ",\"generate_worldgen_page_build\":";
    writeStageStatsJson(out, report.generateWorldgenPageBuildStage);
    out << ",\"generate_worldgen_page_build_surface\":";
    writeStageStatsJson(out, report.generateWorldgenPageBuildSurfaceStage);
    out << ",\"generate_worldgen_page_build_populate\":";
    writeStageStatsJson(out, report.generateWorldgenPageBuildPopulateStage);
    out << ",\"generate_worldgen_page_access_calls\":";
    writeCountStatsJson(out, report.generateWorldgenPageAccessCalls);
    out << ",\"generate_worldgen_page_unique_keys\":";
    writeCountStatsJson(out, report.generateWorldgenPageUniqueKeys);
    out << ",\"generate_worldgen_page_cold_build_count\":";
    writeCountStatsJson(out, report.generateWorldgenPageColdBuildCount);
    out << ",\"generate_worldgen_page_pending_wait_count\":";
    writeCountStatsJson(out, report.generateWorldgenPagePendingWaitCount);
    out << ",\"build_chunk_cpu_warm_pages\":";
    writeStageStatsJson(out, report.buildChunkCpuWarmPagesStage);
    out << ",\"build_chunk_cpu_describe_columns\":";
    writeStageStatsJson(out, report.buildChunkCpuDescribeColumnsStage);
    out << ",\"build_chunk_cpu_materialize_columns\":";
    writeStageStatsJson(out, report.buildChunkCpuMaterializeColumnsStage);
    out << ",\"build_chunk_cpu_apply_structure_edits\":";
    writeStageStatsJson(out, report.buildChunkCpuApplyStructureEditsStage);
    out << ",\"build_chunk_cpu_apply_pending_edits\":";
    writeStageStatsJson(out, report.buildChunkCpuApplyPendingEditsStage);
    out << ",\"build_chunk_cpu_apply_overlay\":";
    writeStageStatsJson(out, report.buildChunkCpuApplyOverlayStage);
    ...
    writeStageStatsJson(out, report.chunkReadyFirstStructureDeferralToReadyStage);
    out << ",\"upload_queue_age\":";
    writeStageStatsJson(out, report.uploadQueueAgeStage);
    out << ",\"structure_query\":";
    writeStageStatsJson(out, report.structureQueryStage);
    out << ",\"generate_deferred_structure_missing_regions\":";
    writeCountStatsJson(out, report.generateDeferredStructureMissingRegions);
    ...
    out << "}";
    out << ",\"generation_detail\":{"
        << "\"base_terrain_state\":";
    writeStageStatsJson(out, report.generateBaseTerrainStateStage);
    out << ",\"structure_resolve\":";
    writeStageStatsJson(out, report.generateStructureResolveStage);
    out << ",\"gpu_input_prep\":";
    writeStageStatsJson(out, report.generateGpuInputPrepStage);
    out << ",\"cpu_materialize\":";
    ...
    out << ",\"publish\":";
    writeStageStatsJson(out, report.generatePublishStage);
    out << ",\"worldgen_page_mutex_wait\":";
    writeStageStatsJson(out, report.generateWorldgenPageMutexWaitStage);
    out << ",\"worldgen_page_pending_wait\":";
    writeStageStatsJson(out, report.generateWorldgenPagePendingWaitStage);
    out << ",\"worldgen_page_build\":";
    writeStageStatsJson(out, report.generateWorldgenPageBuildStage);
    out << ",\"worldgen_page_build_surface\":";
    writeStageStatsJson(out, report.generateWorldgenPageBuildSurfaceStage);
    out << ",\"worldgen_page_build_populate\":";
    writeStageStatsJson(out, report.generateWorldgenPageBuildPopulateStage);
    out << ",\"worldgen_page_access_calls\":";
    writeCountStatsJson(out, report.generateWorldgenPageAccessCalls);
    out << ",\"worldgen_page_unique_keys\":";
    writeCountStatsJson(out, report.generateWorldgenPageUniqueKeys);
    out << ",\"worldgen_page_cold_build_count\":";
    writeCountStatsJson(out, report.generateWorldgenPageColdBuildCount);
    out << ",\"worldgen_page_pending_wait_count\":";
    writeCountStatsJson(out, report.generateWorldgenPagePendingWaitCount);
    out << ",\"cpu_warm_pages\":";
    writeStageStatsJson(out, report.buildChunkCpuWarmPagesStage);
    out << ",\"cpu_describe_columns\":";
    writeStageStatsJson(out, report.buildChunkCpuDescribeColumnsStage);
    out << ",\"cpu_materialize_columns\":";
    writeStageStatsJson(out, report.buildChunkCpuMaterializeColumnsStage);
    out << ",\"cpu_apply_structure_edits\":";
    writeStageStatsJson(out, report.buildChunkCpuApplyStructureEditsStage);
    out << ",\"cpu_apply_pending_edits\":";
    writeStageStatsJson(out, report.buildChunkCpuApplyPendingEditsStage);
    out << ",\"cpu_apply_overlay\":";
    writeStageStatsJson(out, report.buildChunkCpuApplyOverlayStage);
    out << ",\"deferred_structure_missing_regions\":";
    writeCountStatsJson(out, report.generateDeferredStructureMissingRegions);
    out << "}";
    ...
    writeStageStatsJson(out, report.chunkReadyFirstStructureDeferralToReadyStage);
    out << "}";
    out << ",\"exact_gpu_feed_in\":{"
        << "\"build_queue_wait\":";
    writeStageStatsJson(out, report.exactGpuBuildQueueWaitStage);
    out << ",\"queue_depth_enqueue\":";
